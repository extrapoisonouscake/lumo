/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f3b44a3061a9bdd15c2857f2c6189e59)
// Runtime types generated with workerd@1.20251113.0 2025-10-01 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
	}
	interface Env {
		MYED_CREDENTIALS_ENCRYPTION_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MYED_CREDENTIALS_ENCRYPTION_KEY">> {}
}
