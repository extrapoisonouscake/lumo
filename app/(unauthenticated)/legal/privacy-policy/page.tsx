export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 prose prose-zinc dark:prose-invert">
      ...
      <p>
        At Lumo, your privacy is our priority. This Privacy Policy explains how
      ...
      <p>
        Lumo does not sell, trade, or share your personal information. The only
        data transmission occurs between you and MyEducationBC during login.
      </p>
