...
export default function SupportPage() {
  return (
    <>
      <TitleManager>Support</TitleManager>
      <main className="mx-auto max-w-3xl px-4 py-10 prose prose-zinc dark:prose-invert">
        ...
        <p>
          Lumo uses your existing MyEducationBC credentials for authentication.
          If you can&apos;t log in, please verify your username and password at
          the official MyEducationBC portal. If the issue persists, contact us
          with details.
        </p>
